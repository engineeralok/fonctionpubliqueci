  ...
  return (
    <header className="fr-header relative" role="banner">
      ...
      <div className="block lg:hidden bg-white">
        <div className="mx-auto px-4 pt-[10px] pb-2 flex items-center" style={{ width: "100%", position: "relative" }}>
        ...
        <div className="mx-auto px-4 pt-[10px] pb-2 flex items-center border-b border-gray-200" style={{ width: "100%" }}>
          <Link href="/" className="logo-link" aria-label="Retour à l'accueil">
            <Image
              alt="Mobile Logo 2"
      ...
      <div className="desktop-header hidden lg:block w-full">
        ...
        <div className="bg-white pt-[15px] pb-2 px-2 lg:px-2">
