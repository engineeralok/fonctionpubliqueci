...
export default function PhotothequeSection() {
  return (
    <section className="phototheque-section fr-mt-6w">
      <div className="fr-grid-row fr-grid-row--gutters items-center">
        <div className="fr-col-12 phototheque-content-col order-2 md:order-1">
        ...
        <div className="fr-col-12 phototheque-image-col order-1 md:order-2">
