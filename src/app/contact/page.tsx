...
export const metadata: Metadata = {
  title: "Écrire mon message | fonctionpublique.gouv.ci",
      ...
      <main className="contact-page">
        <section className="contact-hero">
          <div className="contact-hero__content">
            ...
            <h1 className="contact-hero__title text-white">Écrire au Ministre</h1>
            <p className="contact-hero__subtitle text-white/90">
              Rentrez en contact avec le Cabinet du Ministre
            </p>
          </div>
        </section>
